...
in {
	wayland.windowManager.hyprland = {
		...
		settings = {
			...
			source = "/home/hypoxie/.config/hypr/colors.conf";
			...
			monitor = [
				...
				"HDMI-A-1,1920x1080@60.01,auto,1,mirror,eDP-1"
			];
			...
			bind = 
				...
				"CTRL, F1, exec, sh -c 'hyprctl monitors | grep -q \"1920x1080@74.97300\" && hyprctl keyword monitor HDMI-A-1,1152x720@60,0x0,1 || hyprctl keyword monitor HDMI-A-1,1920x1080@74.97,0x0,1'"
